...
namespace VersionOfProject
{
    ...
    public partial class AdminDashbordForm : Form
    {
        ...
        public AdminDashbordForm()
        {
            ...
            DGHome.DataSource = Context.AdminHomes.OrderByDescending(a => a.ID).ToList();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (item == 1)
            {
                ...
                else
                {
                    ...
                    Context.SaveChanges();
                    Context.Entry(u).State = Microsoft.EntityFrameworkCore.EntityState.Detached;
                    DGCacher.DataSource = Context.Users.ToList();
                }
            }
            else
        ...
        public void newadmin()
        {
            ...
            adminHome.water_bill = Water_Bill=0;
            adminHome.Electricity_Bill = electricity_Bill = 0;
            adminHome.Gas_Bill = gas_Bill = 0;
            adminHome.Rent = rent=0;
