...
namespace VersionOfProject.Entity
{
    public class WFContext: DbContext
    {
        ...
        {
            optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=CR7\\SQLEXPRESS;Initial Catalog=BellHanaApplicationDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
        }
